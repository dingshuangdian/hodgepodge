package com.lsqidsd.hodgepodge.diyview.refresh;
...
import static com.scwang.smartrefresh.layout.R.*;
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public ClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, styleable.ClassicsHeader);
        ...
        mFinishDuration = ta.getInt(styleable.ClassicsHeader_srlFinishDuration, mFinishDuration);
        ...
        if (ta.hasValue(styleable.ClassicsHeader_srlTextSizeTime)) {
