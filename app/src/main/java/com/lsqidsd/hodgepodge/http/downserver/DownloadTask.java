...
import com.lsqidsd.hodgepodge.http.downserver.exception.HttpException;
import com.lsqidsd.hodgepodge.http.downserver.exception.OkGoException;
import com.lsqidsd.hodgepodge.http.downserver.exception.StorageException;
...
import com.lsqidsd.hodgepodge.http.downserver.task.PriorityRunnable;
import com.lsqidsd.hodgepodge.http.downserver.utils.HttpUtils;
import com.lsqidsd.hodgepodge.http.downserver.utils.IOUtils;
import com.lsqidsd.hodgepodge.http.downserver.utils.OkLogger;
...
public class DownloadTask implements Runnable {
    ...
    public DownloadTask(String tag, Request<File, ? extends Request> request) {
        ...
        progress.fileName = OkDownload.getInstance().getFileName();
